...
cores = [
    ...
    {"core": "semantic", "schema": "solr/schemaSemantic.xml", "url": "http://localhost:8983/solr/semantic/schema"},
    {"core": "boosted", "schema": "solr/schemaBoosted.xml", "url": "http://localhost:8983/solr/boosted/schema"}
]
